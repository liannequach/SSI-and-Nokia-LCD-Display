...
int main(void){
  ...
  PLL_Init();          // bus clock at 80 MHz
	Nokia5110_Init();    // Initializes Nokia 5110 LCD.
  ...
  PortE_Init(); 
	...
	Nokia5110_Clear();								 // Clears Nokia 5110 LCD screen.
  Nokia5110_OutString("************CECS347 LAB3************Speed    Dir-----    ----");  // Display
	Nokia5110_SetCursor(0, 5);
	Nokia5110_OutChar(' ');
	Nokia5110_OutChar('0');
	Nokia5110_OutChar('%');
	Nokia5110_SetCursor(10, 5); 				 // five leading spaces, bottom row
	Nokia5110_OutChar('F');
